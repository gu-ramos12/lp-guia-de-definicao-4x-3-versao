...
export function OfferSection() {
  // Fires ViewContent the first time the offer section enters the viewport
  const handleViewContent = useCallback(() => {
    trackEvent('ViewContent', {
      content_name: 'Guia de Definição 4X',
  ...
  const sectionRef = useInView<HTMLElement>(handleViewContent, 0.3);

  return (
    <section ref={sectionRef} id="oferta" className="py-12 md:py-20 bg-gradient-to-br from-slate-100 to-white">
                  ...
                  <div className="space-y-6 md:space-y-8">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-3xl sm:text-4xl font-bold text-green-400 mb-2">
                        <span className="text-base sm:text-lg">12x </span>R$ 15,11
                      </div>
                      <div className="text-green-400 text-lg sm:text-xl">à vista R$ 147,00 (64% OFF)</div>
                    ...
                    <Button asChild size="lg" className="w-full bg-green-500 hover:bg-green-600 text-black py-3 sm:py-4 text-base sm:text-lg">
                      <a
                        href="https://payfast.greenn.com.br/kw2t8mr?utm_source=lp&utm_medium=cta&utm_content=offer"
                        onClick={() =>
