  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-slate-800/95 backdrop-blur-sm border-b border-slate-700">
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between">
        ...
        <Button asChild className="bg-green-500 hover:bg-green-600 text-black text-xs sm:text-sm px-3 sm:px-4 py-2">
          <a
            href="https://payfast.greenn.com.br/kw2t8mr?utm_source=lp&utm_medium=cta&utm_content=header"
            onClick={() => trackEvent('InitiateCheckout', { source: 'header' })}
          >
            Adquirir Agora
          </a>
        </Button>
