      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8 md:space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Button size="lg" className="bg-green-500 hover:bg-green-600 text-black text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto">
              Começar Transformação
            </Button>
            <Button size="lg" variant="outline" className="border-green-400 text-green-400 hover:bg-green-400 hover:text-black transition-all duration-300 text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto">
              Ver Resultados
            </Button>
          </div>
