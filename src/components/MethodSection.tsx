    ...
    <section className="py-12 md:py-20 bg-slate-900">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center px-4">
          <Button asChild size="lg" className="bg-green-500 hover:bg-green-600 text-black text-sm sm:text-base md:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto">
            <a
              href="https://payfast.greenn.com.br/kw2t8mr?utm_source=lp&utm_medium=cta&utm_content=method"
              onClick={() => trackEvent('InitiateCheckout', { source: 'method' })}
            >
